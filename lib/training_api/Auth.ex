defmodule TrainingManagement.Auth do
    use GenServer
    use Timex
    import Joken
    require Logger
    ...
    alias TrainingManagement.Helpers.MapHelper

    @app_secret_key Application.get_env(:trainingManagement, :app_secret_key)
    @jwt_validity Application.get_env(:trainingManagement, :jwt_validity)
